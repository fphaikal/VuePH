...
<div class="col-6 my-auto d-flex justify-content-end">
  ...
  <div class="col-md-12 mt-2">
    <div class=" rounded-4 p-3" style="background-color: #282b30;">
      <div v-if="loading">
                ...
                <RouterLink :to="'/recent-live/' + recent.member.url + '/' + recent.data_id">
                  <div class="card rounded-4" style="background-color: #1e2124;">
                    ...
                    <div class="card-body text-light">
                      <h5 class="card-title mb-1">{{ getShortName(recent.member.url) }}</h5>
                      <div class="d-flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock-history my-auto" viewBox="0 0 16 16">
                        ...
                        <small class="my-auto ms-1">{{ formatTimeAgo(recent.live_info.date.end) }}</small>
                      </div>
                    </div>
                  </div>
                </RouterLink>
