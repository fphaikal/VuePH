  ...
  <main>
    ...
    >
      <div class="container-fluid">
        ...
        <div v-else-if="memberLive.is_live && liveInfo">
        ...
        <div v-else>
          <div class="row p-0 g-2">
            <div class="col-md-9">
              ...
              <div class="row mt-3">
                <RouterLink :to="'/member/' + memberLive.room_url_key + '/' + memberLive.room_id" class="col-md-2 col-4 my-auto">
                  <img
                    :src="memberLive.image"
                    class="img-fluid rounded-4"
                    alt=""
                ...
                <RouterLink :to="'/member/' + memberLive.room_url_key + '/' + memberLive.room_id" class="col-md-10 col-8 my-auto text-light">
                  <h3 class="">{{ memberLive.name }}</h3>
                </RouterLink>
              </div>
            </div>
