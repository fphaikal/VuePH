...
<template>
  <main>
    <div
      class="full-height-section text-light container"
    ...
    >
      <div v-if="memberInfo || memberInfoDetail">
        <div class="row mt-3">
          ...
          >
            <div class="p-2 rounded-pill text-bg-success">
          ...
          <div class="col-md-4">
            ...
            >
              ...
              <div v-if="memberInfo.is_onlive">
                <RouterLink
                  :to="
                    '/watch/' + memberInfo.room_url_key + '/' + memberInfo.id
                  "
                  class="card-body text-light text-center"
                >
        ...
        <div v-if="selectedOption === '7 Hari'">
          ...
          <div v-else>
            <div class="row mt-2">
              <div class="col-12">
                <div
                  class="card text-light rounded-4"
                  style="background-color: #282b30"
                >
              ...
              <div class="col-12 rounded-4" style="background-color: #282b30">
                <div class="row p-3">
                  <div class="col-12">
                    ...
                    <div class="row mt-3 g-1">
                      <div
                        v-for="(data, index) in fansAll.slice(0, 12)"
                        :key="data.id"
                        class="col-md-4 mb-3"
                      >
                        <div class="row g-1">
...
export default {
  ...
  async mounted() {
    try {
      ...
      //GET Statistik API
      this.statsWeek = await getShowroomDataDetail(
        `stats?type=weekly&room_id=${roomId}`
      );
      this.statsMonthly = await getShowroomDataDetail(
        `stats?type=monthly&room_id=${roomId}`
      );
      this.statsAll = await getShowroomDataDetail(
        `stats?type=all&room_id=${roomId}`
      );
