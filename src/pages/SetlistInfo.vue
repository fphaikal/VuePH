      ...
      <div class="container">
        <div v-if="setlistInfo">
          <div class="row g-2 mt-2">
            <div class="col-md-8">
              <div
                class="ratio ratio-16x9 d-none d-md-block shadow"
              ...
              <div class="row mt-3">
                <div class="col-md-12">
                  <div class="row">
                    ...
                    <div
                      class="col-md-8 d-flex justify-content-center justify-content-md-end"
                    >
                      <svg
                      ...
                      <svg
                        ...
                        height="20"
                        fill="currentColor"
                        class="bi bi-clock-fill my-auto ms-3"
                        viewBox="0 0 16 16"
                      >
                        <path
                  ...
                  <div
                    class="card mt-2 rounded-4 shadow"
                  ...
                  <div class="row g-2 mt-1">
                    <div class="col-md-6">
                      <a
                        :href="setlistInfo.ticketShowroom"
                        class="card rounded-4 bg-success shadow"
                      >
                    ...
                    <div class="col-md-6">
                      <a
                        :href="setlistInfo.ticketTheater"
                        class="card rounded-4 bg-danger shadow"
                      >
                        <div class="card-body text-light d-flex">
                  ...
                  <div
                    class="card mt-3 mb-3 rounded-4"
                    style="background-color: #282b30"
                  >
                    <div class="card-body text-light">
                      ...
                      >
                        <div
                          v-for="(setlist, index) in setlistInfo.setlist.songs"
                        >
                          <div class="row g-2">
                            ...
                            <div class="col-8 col-md-8 my-auto">
                              <h5 class="mb-0">
                                {{ setlist.translatedTitle ?? setlist.title }}
                              </h5>
                            </div>
                            <hr />
                          </div>
            ...
            <div class="col-md-4">
              ...
              >
                <div class="card-body text-light">
                  ...
                  <div class="row g-2 mt-2">
                    <div
                      v-for="member in setlistInfo.memberList"
                      :key="member._id"
